...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("spec"))
        return false;
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "SPEC.lnk";
}
...
{
    return GetAutostartDir() / "spec.desktop";
}
