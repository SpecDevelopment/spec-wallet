...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SPEC " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"speccoin.com", "node.speccoin.com"},
    {"speccoin.com", "node2.speccoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SPEC is probably already running."), addrBind.ToString().c_str());
        else
